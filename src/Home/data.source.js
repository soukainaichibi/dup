...
export const Nav30DataSource = {
  ...
  logo: {
    className: 'header3-logo kfu9ueyruzn-editor_css',
    children:
      'https://res.cloudinary.com/dupagadir/image/upload/c_scale,w_200/v1601759367/Untitled-2_a1wgjl.png',
  },
  Menu: {
...
export const Content110DataSource = {
  OverPack: {
    className: 'home-page-wrapper content11-wrapper kftmyoxgz2h-editor_css',
    playScale: 0.3,
    replay: false,
  },
  titleWrapper: {
    ...
    children: [
      {
        ...
        children:
          'https://res.cloudinary.com/dupagadir/image/upload/c_scale,w_200/v1601759367/Untitled-2_a1wgjl.png',
        className: 'title-image kfu9a4rhklc-editor_css',
      },
      {
        name: 'title',
        children: (
            ...
            <span>
              <span>
                <span>
                  <span>
                    <p>
                      Development , Design, Professional Hosting, Emails severe
                      , Maintenance, socials marketing&nbsp;
                    </p>
                  </span>
                </span>
              </span>
      ...
      },
      {
        ...
        children: (
          <span>
            <p>boost your projects with us.</p>
          </span>
        ),
        className: 'title-content',
      },
  ...
  button: {
    className: 'kftmyukusw-editor_css',
    children: {
      a: {
        className: 'button kftz5ywibh-editor_css',
        href: '#',
        children: (
          <span>
            <p>services</p>
        ...
        titleWrapper: {
          children: [
            ...
            },
            {
              ...
              children: (
                <span>
                  <p>full stack Developer/sysAdmin</p>
                </span>
              ),
            },
            {
      ...
      },
      {
        ...
        titleWrapper: {
          children: [
            {
              name: 'image',
              className: 'teams1-image kfu83osrxd-editor_css',
              children:
                'https://res.cloudinary.com/dupagadir/image/upload/v1601763165/prototyp_lfohfq.png',
            },
            {
              name: 'title',
              className: 'teams1-title',
...
export const Feature50DataSource = {
  ...
  page: { className: 'home-page content7 kftmwe0d9zr-editor_css' },
  OverPack: {},
  titleWrapper: {
    className: 'title-wrapper',
    children: [
      ...
      },
      {
        ...
        children: (
          <span>
            <p>high responsive products for all devices</p>
          </span>
        ),
      },
    ],
...
export const Pricing00DataSource = {
  ...
  img: {
    ...
    name: 'image',
    children:
      'https://res.cloudinary.com/dupagadir/image/upload/v1601817874/A_OnyWT4Nsxy0AAAAAAAAAAABjARQnAQ_dydf4y.png',
  },
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <span>
            <p>
              A responsive web application that can deploed as an PWA app with
              nodeJs server, this application&nbsp;
            </p>
          </span>
        ),
      ...
      },
      {
        ...
        children: {
          ...
          href: '#',
          type: 'default',
          className: 'kfv559dcfde-editor_css',
        },
      },
    ],
  },
...
export const Content120DataSource = {
  wrapper: {
    className: 'home-page-wrapper content12-wrapper kftn9pyaidm-editor_css',
  },
  page: { className: 'home-page content12 kftn9d4wf2n-editor_css' },
  OverPack: { playScale: 0.3, className: '' },
  titleWrapper: {
    className: 'title-wrapper',
    children: [
...
export const Contact01DataSource = {
  wrapper: {
    className: 'home-page-wrapper content10-wrapper kftml2ejeea-editor_css',
  },
  Content: {
    ...
    children: {
      ...
      url: {
        children: 'https://goo.gl/maps/q8etrMxJ1G8K9ZACA',
        name: '跳转地址',
      },
    ...
    children: [
      {
        ...
        className: 'block',
        title: {
          className: 'logo kfv406lsws7-editor_css',
          children:
            'https://res.cloudinary.com/dupagadir/image/upload/c_scale,w_200/v1601759367/Untitled-2_a1wgjl.png',
        },
        childWrapper: {
          ...
          children: [
            {
              ...
              children: (
                <span>
                  <span>
                    <span>
                      <p>Digitalify your project A.E.</p>
                    </span>
                  </span>
                </span>
              ),
